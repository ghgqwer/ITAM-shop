...
function create_if_block_5(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      add_location(style, file, 365, 1, 9488);
    },
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file, 597, 3, 14927);
      attr_dev(button, "type", "button");
      attr_dev(button, "class", "super-debug--copy");
      add_location(button, file, 599, 4, 15020);
      attr_dev(div1, "class", "super-debug--right-status");
      add_location(div1, file, 598, 3, 14976);
      ...
      add_location(div2, file, 592, 2, 14788);
      attr_dev(code, "class", "super-debug--code");
      add_location(code, file, 651, 19, 16677);
      ...
      add_location(pre, file, 647, 2, 16543);
      ...
      add_location(div3, file, 586, 1, 14676);
    },
    m: function mount(target, anchor) {
...
function create_else_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(path0, file, 623, 9, 15920);
...
function create_if_block_4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(path0, file, 608, 9, 15360);
      attr_dev(path1, "d", "M4.012 16.737A2.005 2.005 0 0 1 3 15V5c0-1.1.9-2 2-2h10c.75 0 1.158.385 1.5 1");
      add_location(path1, file, 610, 10, 15525);
      attr_dev(g, "fill", "none");
      attr_dev(g, "stroke", "currentColor");
      attr_dev(g, "stroke-linecap", "round");
      attr_dev(g, "stroke-linejoin", "round");
      attr_dev(g, "stroke-width", "2");
      add_location(g, file, 602, 8, 15210);
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      attr_dev(svg, "width", "1em");
      attr_dev(svg, "height", "1em");
      attr_dev(svg, "viewBox", "0 0 24 24");
      add_location(svg, file, 601, 6, 15117);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, svg, anchor);
      append_hydration_dev(svg, g);
...
function create_if_block_3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 636, 5, 16208);
    },
    m: function mount(target, anchor) {
...
function create_if_block_2(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(654:6) {#if assertPromise($debugData, raw, promise)}",
    ctx
  });
  return block;
}
function create_catch_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file, 656, 23, 16978);
      html_tag.a = html_anchor;
    },
    m: function mount(target, anchor) {
...
function create_pending_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 653, 70, 16790);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
    },
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "pending",
    source: '(654:70) <div         class=\\"super-debug--promise-loading\\">Loading data...</div>{:then result}',
    ctx
  });
  return block;
}
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(path, file, 675, 6, 17508);
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      ...
      add_location(svg, file, 669, 4, 17355);
      attr_dev(button, "type", "button");
      attr_dev(button, "class", "super-debug--collapse");
      attr_dev(button, "aria-label", "Collapse");
      add_location(button, file, 663, 3, 17200);
    },
    m: function mount(target, anchor) {
...
function _defaultValues(schema, isOptional, path) {
  ...
  if (info.properties) {
    for (const [key, objSchema] of Object.entries(info.properties)) {
      ...
      const def = objectDefaults && objectDefaults[key] !== void 0 ? objectDefaults[key] : _defaultValues(objSchema, !((_a = info.required) == null ? void 0 : _a.includes(key)), [...path, key]);
      output[key] = def;
    }
    return output;
  ...
  if (info.additionalProperties && info.types.includes("object")) {
    ...
    if (additionalInfo.properties && additionalInfo.types.includes("object")) {
      for (const [key] of Object.entries(additionalInfo.properties)) {
        output[key] = _defaultTypes(additionalInfo.properties[key], !((_b = additionalInfo.required) == null ? void 0 : _b.includes(key)), [...path, key]);
      }
    }
  }
...
function superForm(form, formOptions) {
  ...
  function Form_capture(removeFilesfromData = true) {
    ...
    if (removeFilesfromData) {
      const removed = removeFiles2(Data.form);
      data = removed.data;
