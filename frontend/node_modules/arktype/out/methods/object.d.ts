...
import type { associateAttributes, Attributes, Default, of, Optional } from "../attributes.ts";
...
type typeProp<o, k extends keyof o, $, t = o[k] & ({} | null)> = t extends of<infer base, infer attributes> ? attributes extends Default<infer defaultValue> ? DefaultedTypeProp<k & Key, keyof attributes extends keyof Default ? base : of<base, Omit<attributes, keyof Default> extends (infer attributes extends Attributes) ? attributes : never>, defaultValue, $> : attributes extends Optional ? BaseTypeProp<"optional", k & Key, keyof attributes extends keyof Optional ? base : of<base, Omit<attributes, keyof Default> extends (infer attributes extends Attributes) ? attributes : never>, $> : never : BaseTypeProp<k extends optionalKeyOf<o> ? "optional" : "required", k & Key, t, $>;
...
type fromTypeProps<t, props extends array<MappedTypeProp>> = show<{
    ...
    [prop in props[number] as Extract<applyHomomorphicOptionality<t, prop>, {
        kind: "optional";
        default: unknown;
    }>["key"]]: associateAttributes<prop["value"][inferred], Default<prop["default" & keyof prop]>>;
}>;
