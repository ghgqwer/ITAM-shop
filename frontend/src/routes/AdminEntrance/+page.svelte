<script lang="ts">
	...
	async function handleSubmit(event: Event) {
        ...
        try{
            ...
            credentials: 'include' // Включаем куки при запросах
        });
...
<div class="EntrancePanel">
	<div class="EntP1">
		<div class="EntP2">
			<div class="header1">
				<div class="txt">Войдите в админ-панель</div>
			</div>
			<form on:submit={handleSubmit}>
				...
				<div class="buttons">
					...
					<button class="EnterAsAdmin" on:click={()=>{enterAsUser()}}>Войти как пользователь</button>
				</div>
			</form>
		</div>
