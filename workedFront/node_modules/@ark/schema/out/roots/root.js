import { includes, inferred, omit, throwInternalError, throwParseError, unset } from "@ark/util";
...
export class BaseRoot extends BaseNode {
    ...
    get optionalMeta() {
        return this.cacheGetter("optionalMeta", this.meta.optional === true ||
            (this.hasKind("morph") && this.in.meta.optional === true));
    }
    /** returns unset if there is no default */
    get defaultMeta() {
        return this.cacheGetter("defaultMeta", "default" in this.meta ? this.meta.default
    ...
    pipeOnce(morph) {
        ...
        return this.distribute(branch => branch.hasKind("morph") ?
            ...
            if (!this.hasKind("union"))
                return this.$.parseSchema(branches[0]);
            const schema = {
                branches
            };
            if ("default" in this.meta)
                schema.meta = { default: this.meta.default };
            else if (this.meta.optional)
                schema.meta = { optional: true };
